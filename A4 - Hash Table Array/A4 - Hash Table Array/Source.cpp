...
void testSimpleIntHash() {
	...
	//Attempt to retrieve some
	checkTest("testSimpleIntHash #19", "Thunder", myHash.item(12));
	checkTest("testSimpleIntHash #20", "Bucks", myHash.item(77));
	checkTest("testSimpleIntHash #21", "Hornets", myHash.item(123));
